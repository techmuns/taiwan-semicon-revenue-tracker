 ...
 *
 * Named for what it is - the `movers()` stats function is what it renders. It
 * was called `Insights`, which is now the tab that asks a different question:
 * this one ranks COMPANIES within the current filter, that one asks which STAGE
 * stands out and which name inside it is big enough to be driving it.
 *
